...
/**
 * Helper class to handle string format operations / zip, unzip, convert to/from "UTF-8"
 * 
...
public class StringFormatter {
	/**
	 * Unzip compressed string to raw format string output
	 * 
	 * @param str
	 *            input string.
	...
	/**
	 * Unzip compressed array of bytes to raw format string output
	 * 
	 * @param bytes
